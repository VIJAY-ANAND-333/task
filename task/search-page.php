    ...
    $(document).ready(function() {
            ...
            function displayProducts(products) {
                ...
                products.forEach(function(product) {
                    var listItem = $("<li>").html("<strong>" + product.name + "</strong><br>" + product.description);
        ...
        $(document).ready(function() {
            $("#getbrand").click(function() {
                ...
                $.ajax({
                    url: "process.php",  // PHP script to handle the request
                    type: "POST",
                    data: {},
                    success: function(response) {
                        $("#result").html(response); // Update a HTML element with the response
                    }
                });
            });
        })
    ...
    <div class="collapse navbar-collapse" id="navbarSupportedContent">
      ...
      <div>
        <div type="button" class="btn" data-toggle="modal" data-target="#signInModal">
          <img src="./assets/Images/user.png" alt="" style="height: 20px;">
        </div>
        <div type="button" class="btn"><img src="./assets/Images/bell.png" alt="" style="height: 20px;"></div>
        <div type="button" class="btn"><img src="./assets/Images/heart.png" alt="" style="height: 20px;"></div>
        <div type="button" class="btn"><img src="./assets/Images/shopping-cart.png" alt="" style="height: 20px;"></div>
      </div>
    </div>
  </nav>
...
<!-- search bar of bike site  -->
  <div class="bg-warning py-2 d-flex justify-content-center">
    <form class="form-inline">
      ...
      <button class="btn btn-outline-success my-2 px-4 my-sm-0 text-white bg-primary rounded-pill"
        type="submit"><img src="./assets/Images/loupe.png" alt="" style="height: 1rem;"></button>
    </form>
  </div>
</section>
  ...
  <!-- part 1 of bike-site -->
  <section class="mt-3 d-flex justify-content-center align-items-center" style="margin-right: -10px !important; background-color: #ebebeb ;">
  ...
  <section class="py-8 px-5" >
    ...
    <div class="container mt-5">
      <div class="row">
        <div class="col-md-4">
          <div class="font-weight-bold h4">SHOP BY BIKE</div>
        </div>
        <div class="col-md-8 d-flex justify-content-end">
          <div class="dropdown">
            ...
            <div class="dropdown-menu" aria-labelledby="searchBrandDropdown">
              ...
              echo"<a class='dropdown-item' href='search-page.php'>$model_name</a>";
              }
              ?>
            </div>
          </div>
    ...
    <div class="owl-carousel owl-theme">
      ...
      <div class="item">
        <div class="text-center"><img src="<?php echo './assets/bikes/'.$model['image'];?>"
            alt="">
          <h6>Royel Enfield</h6>
        </div>
      </div>
  ...
  <!-- part 4 of page? -->
  <section class="py-4" style="background-color: #ebebeb ;">
    <div class="ml-3">
      <div class="row">
  ...
  <!-- part 5 bike page -->
  <section class="pb-4" style="background-color: #ebebeb ;">
    <div class="ml-3">
      <div class="row">
...
<section class="py-8 px-5" >
  <div class="container mt-5">
    <div class="row">
      <div class="col-md-4">
        <div class="font-weight-bold h4">AUXILIARY LIGHT</div>
      </div>
    </div>
  </div>
