				...
				<section class="content">
					...
					<div class="container-fluid">
						<div class="card">
							<div class="card-body">								
								<div class="row">
								<form action="edit_sub_cat.php"  method="post" enctype="multipart/form-data">
									<div class="col-md-6">
										<div class="mb-3">
                                        <input type="hidden" name="id" value="<?php echo $row["id"]; ?>">
											<label for="brand">Fname</label>
											<input type="text" name="fname" value="<?php echo $row['fname'];?>" id="brand" class="form-control" placeholder="Name">	
										</div>
									</div>
                                    <div class="col-md-6">
										<div class="mb-3">
											<label for="category">Category</label>
											<input type="text" value="<?php echo $row['category'];?>"  name="category" id="category" class="form-control" placeholder="Category">	
										</div>
									</div>	
									<div class="col-md-6">
										<div class="mb-3">
											<label for="quantity">Slug</label>
											<input type="text" id="qty" value="<?php echo $row['slug'];?>" name="slug" placeholder='Quantity'>	
										</div>
									</div>
                                    <div class="col-md-6">
										<div class="mb-3">
