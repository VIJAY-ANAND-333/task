					...
					<div class="container-fluid my-2">
						<div class="row mb-2">
							...
							<div class="col-sm-6 text-right">
								<a href="create-product.html" class="btn btn-primary">Edit Product</a>
							</div>
						</div>
					</div>
					<!-- /.container-fluid -->
								...
								<table class="table table-hover text-nowrap">
									...
									<tbody>
                                        ...
                                        <?php foreach ($results as $product) : ?>
											...
											<td><?php echo $product['compared_price'];?></td>
											<td><?php echo $product['SKU'];?></td>
											<td><img src='uploads/errors.png' width='60' height='60' alt=""/>
										    </tr>
										...
										<tr>
                                        <?php global $i; while($rows = mysqli_fetch_assoc($res)){ ?>
											<td><?php echo $rows['id'];?></td>
											<td><?php echo $rows['title'];?></td>
                                            <td><?php echo $rows['compared_price'];?></td>
											...
											<td>
												<a href="edit_pro.php?id=<?php echo $rows["id"]; ?>">
