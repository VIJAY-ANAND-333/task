...
$host = "localhost";
    ...
    $id=$_GET['id'];
    $sql="SELECT * FROM shipping_charges where id='$id'";
		...
		<div class="wrapper">
			...
			<div class="content-wrapper">
				...
				<section class="content">
					<!-- Default box -->
					<form action="edit_ship.php" method="post" enctype="multipart/form-data">
                                        ...
                                        <div class="row">
                                            <div class="col-md-12">
												...
												<input type="hidden" name="id" value="<?php echo $categories["id"]; ?>">
                                                    <label for="title">Country_id</label>
                                                    <select name="country_id" id="country_id" class="form-control">
                                                    <?php
                                                    foreach($countries as $country){?>
                                                    <option <?php echo $country['id']==$categories['id'] ? "selected" :"";?> value="<?php echo $country['id'];?>"><?php echo $country['country'];?></option>	
                                                    <?php } ?>
                                                    </select>
                                                </div>
                                            </div>
											<div class="col-md-12">
                                                <div class="mb-3">
                                                    ...
                                                    <input type="number"  value="<?php echo $categories['amount'];?>" name="amount" id="amount" cols="30" rows="10"  placeholder="Amount"/>
                                                </div>
                                            </div> 
