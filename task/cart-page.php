...
<nav class="navbar navbar-expand-lg navbar-light py-3 bg-info ">
    <a class="navbar-brand text-white" href="home.php"><img src='assets/logo/logo.png' width='50' height='50' alt=''/></a>
    ...
    <div class="collapse navbar-collapse" id="navbarSupportedContent">
      ...
      <div>
        ...
        <button class="btn btn-success"><a href='checkout.php'>checkout</a></button></div>
      </div>
    </div>
  </nav>
    <center>
